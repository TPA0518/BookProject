...
toppings = ['mushrooms', 'extra cheese', 'pepperoni', 'beef']
...
if personAge < 2:
    ...
    print('\nPerson is a kid.')
elif 13 < personAge < 20:
    print('\nPerson is a teenager.')
elif 20 < personAge < 65:
    print('\nPerson is an adult.')
elif personAge >= 65:
    print('\nPerson is an elder.')
...
favFruits = ['watermelon', 'apple', 'orange']
if 'watermelon' in favFruits:
    print('You really like watermelons.')
if 'apple' in favFruits:
    print('You really like apples.')
if 'orange' in favFruits:
...
requested_toppings = ['mushrooms', 'green peppers', 'extra cheese']
for requested_topping in requested_toppings:
    if requested_topping in availableToppings:
        print("\nAdding " + requested_topping + ".")
    else:
